...
import { MemberNumber, MemberNumberCodec, PracticalId, PracticalIdCodec } from '../types'
...
export const joinPractical = (memberNumber: MemberNumber, practicalId: PracticalId): JoinPractical => ({
