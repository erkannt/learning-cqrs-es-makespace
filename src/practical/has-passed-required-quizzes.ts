...
const passedQuizzes = (history: ReadonlyArray<Event>, memberNumber: MemberNumber) =>
  pipe(
    history,
...
const requiredQuizzes = (history: ReadonlyArray<Event>, practicalId: PracticalId) =>
  pipe(
    history,
...
export const hasPassedRequiredQuizzes: HasPassedRequiredQuizzes = history => command =>
  pipe(
    {
