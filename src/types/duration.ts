...
const HoursCodec = t.brand(t.Int, (input): input is t.Branded<t.Int, HoursBrand> => input > 0, 'Hours')
...
const MinutesCodec = t.brand(t.Int, (input): input is t.Branded<t.Int, MinutesBrand> => input > 0, 'Minutes')
